...
export const registerClientSchema = z.object({
    ...
    ci: z.string({required_error:"El ci es requerido"}).min(7, "El ci debe tener al menos 7 caracteres"),
    ...
    rol: z.number({required_error:"El rol es requerido"}).min(1, "El rol debe ser 1 o 2"),
